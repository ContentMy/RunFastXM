 ...
 */
object TargetLoggerManager {

    /**
     * @Author: ContentMy
     * @return: TargetLoggerInterface 返回日志接口类型
     * @Description:
     ...
     */
    inline fun <reified T> getLogger(): TargetLoggerInterface {
        return TargetLoggerImpl(T::class.java.simpleName)
    }
}