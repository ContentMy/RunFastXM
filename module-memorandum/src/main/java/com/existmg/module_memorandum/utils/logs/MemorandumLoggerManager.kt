 ...
 */
object MemorandumLoggerManager {

    /**
     * @Author: ContentMy
     * @return: MemorandumLoggerInterface 返回日志接口类型
     * @Description:
     ...
     */
    inline fun <reified T> getLogger(): MemorandumLoggerInterface {
        return MemorandumLoggerImpl(T::class.java.simpleName)
    }
}