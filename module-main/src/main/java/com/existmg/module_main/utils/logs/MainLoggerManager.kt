 ...
 */
object MainLoggerManager {

    /**
     * @Author: ContentMy
     * @return: MainLoggerInterface 返回日志接口类型
     * @Description:
     ...
     */
    inline fun <reified T> getLogger(): MainLoggerInterface {
        return MainLoggerImpl(T::class.java.simpleName)
    }
}