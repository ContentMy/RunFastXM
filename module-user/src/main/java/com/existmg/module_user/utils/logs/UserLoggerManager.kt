package com.existmg.module_user.utils.logs
 ...
 */
object UserLoggerManager {

    /**
     * @Author: ContentMy
     * @return: UserLoggerInterface 返回日志接口类型
     * @Description:
     ...
     */
    inline fun <reified T> getLogger(): UserLoggerInterface {
        return UserLoggerImpl(T::class.java.simpleName)
    }
}